...
// modulo inventasse a propria, nenhum adapter serviria a dois. O `core/ports/` do modulo
...
/**
 * Nomes validos de porta. `config/ports.json` e `modulo.json:ports` usam este vocabulario.
 *
