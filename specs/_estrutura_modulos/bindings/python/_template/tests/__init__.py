...
# local — a ordem do path nao salva. Regular aqui fecha essa porta. `tests/contrato/` e
# `tests/dominio/` nao precisam do mesmo: uma vez que "tests" e regular, os dois so sao procurados
