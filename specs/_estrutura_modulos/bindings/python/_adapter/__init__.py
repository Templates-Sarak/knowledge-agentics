...
da porta "<porta>" (packages/portas/__init__.py) — o TODO abaixo e o unico lugar que falta.
...
class AdapterPendente:
    """TODO: implemente os metodos da porta "<porta>" aqui (packages/portas/__init__.py)."""
