...
`_PaginaDoMolde`), nunca `core.dominio.Registro`/`core.portas.Pagina` do modulo chamador:
`adapters/` nao pode importar de `modulos/` (regra `adapter-isolado`), e um projeto pode ter varios
modulos, cada um com o PROPRIO `core.dominio`. As classes locais so precisam ter os MESMOS campos —
...
# ====================================================================================================
# REPOSITORIO — objetos locais (nunca `core.dominio` do modulo chamador, ver o cabecalho).
# ====================================================================================================
...
#
# Este adapter cobre a FORMA DO MOLDE — as duas tabelas que `criar-modulo.mjs` ja entrega. O que
